...
%%
% create the n x n FIELD with wallpercent walls containing movement costs, a starting position STARTPOSIND, a goal position GOALPOSIND, the costs 
% A star will compute movement cost for each tile COSTCHART, and a matrix in which to store the pointers FIELDPOINTERS
