...
%    For the noninterruptible button, events on the queue must wait to be 
...
%    If you first clicked the noninterruptible Wait button, the Surf Plot 
...
% -----------------------------------------------------------------------
% Executes when you click the Wait (noninterruptible) push button.
    function wait_noninterruptible(hObject,eventdata)
        % Disable the other key.
